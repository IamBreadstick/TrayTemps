...
- GPU temperatures work without PawnIO.
- CPU temperatures require PawnIO because LibreHardwareMonitor uses it for low-level CPU sensor access on many systems.
